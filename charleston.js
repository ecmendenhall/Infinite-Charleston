...
function get_seconds() {
	...
	var tweet_href = "https://twitter.com/intent/tweet" + "?" + encodeURIComponent("url") +"=" + encodeURIComponent(url) + "&" + encodeURIComponent("text") +"=" +encodeURIComponent(text) + "&" + encodeURIComponent("related") + "=" + encodeURIComponent(related);
